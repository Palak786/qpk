...
import com.qpk.DirectionFinder;
import com.qpk.DirectionFinderListener;
import com.qpk.MyApplication;
import com.qpk.R;
import com.qpk.Route;
...
public class NavigationActivity extends FragmentActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     //   ((TextView)findViewById(R.id.title)).setText(controller.getTitle());
                ...
                switch (status.getStatusCode()) {
                    case LocationSettingsStatusCodes.SUCCESS:
                        ...
                        LocationServices.FusedLocationApi.requestLocationUpdates(
                                mGoogleApiClient, mLocationRequest,NavigationActivity.this);
                        break;
    ...
    public void onDirectionFinderSuccess(List<Route> routes) {
        ...
        for (Route route : routes) {
            ...
            mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(route.endLocation, 10));
            ...
            PolylineOptions polylineOptions = new PolylineOptions().
                    geodesic(true).
                    color(getResources().getColor(R.color.path_colour)).
                    width(10);
