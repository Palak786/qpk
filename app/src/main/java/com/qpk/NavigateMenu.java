...
public class NavigateMenu extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener,OnMapReadyCallback, DirectionFinderListener, Response.Listener<String>, Response.ErrorListener,  GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_navigate_menu);
    ...
    protected void onResume() {
        ...
        gps=new GPSTracker(NavigateMenu.this);
        ...
        btnFindPath.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (origin.isEmpty()) {
                    Toast.makeText(NavigateMenu.this, "Please enter origin address!", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (destination.isEmpty()) {
                    Toast.makeText(NavigateMenu.this, "Please enter destination address!", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                try {
                    new DirectionFinder(NavigateMenu.this, origin, destination).execute();
...
// startActivity(new Intent(NavigateMenu.this,MapsActivity.class));
                ...
                if (etDestination.getText().length() > 3) {
                    ...
                    Runnable run = new Runnable() {
                        ...
                        public void run() {
                            ...
                            request = new VolleyJSONRequest(Request.Method.GET, getPlaceAutoCompleteUrl(etDestination.getText().toString()), null, null,NavigateMenu.this, NavigateMenu.this);
                ...
                if (etOrigin.getText().length() > 3) {
                    ...
                    Runnable run = new Runnable() {
                        ...
                        public void run() {
                            ...
                            //build Get url of Place Autocomplete and hit the url to fetch result.
                            request = new VolleyJSONRequest(Request.Method.GET, getPlaceAutoCompleteUrl(etOrigin.getText().toString()), null, null,NavigateMenu.this, NavigateMenu.this);
...
/*        searchEdit.setOnEditorActionListener(new OnEditorActionListener()
    ...
    public void onErrorResponse(VolleyError error) {
        Toast.makeText(NavigateMenu.this,""+error,Toast.LENGTH_LONG).show();
    ...
    public void onResponse(String response) {
        ...
        if (mAutoCompleteAdapter == null) {
            mAutoCompleteAdapter = new AutoCompleteAdapter(this, predictions.getPlaces(),NavigateMenu.this);
    ...
    public void showSettingsAlert(){
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(NavigateMenu.this);
        ...
        protected void onPostExecute(List<HashMap<String, String>> list) {
            ...
            if(list!=null){
               ...
               /* destinationLatLan=list.get(list.size()-1).get("lat")+","+list.get(list.size()-1).get("lng");
                ...
                Toast.makeText(NavigateMenu.this,"NO PARKING AREA",Toast.LENGTH_LONG).show();
            }
        ...
        public boolean onMarkerClick(Marker marker) {
            ...
            class Mapstuff extends AsyncTask<String, Void, String>
            {
                ...
                protected void onPreExecute() {
                    super.onPreExecute();
                    loading = ProgressDialog.show(NavigateMenu.this, "Searching...", null, true, true);
                }
